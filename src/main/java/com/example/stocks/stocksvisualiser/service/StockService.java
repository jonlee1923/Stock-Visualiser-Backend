...
public interface StockService {
    ResponseEntity<List<TickerResponse>> getTicker(String symbol, Timespan timespan, @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate from, @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate to);
}
